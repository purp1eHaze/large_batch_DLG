...
CUDA_VISIBLE_DEVICES=2 python main.py --model resnet --dataset imagenet --trained_model --cost_fn sim --indices def --restarts 1 --num_images 1 --save_image --target_id -1 --data_path /home/lbw/Data
